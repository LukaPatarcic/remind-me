                ...
                <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                    <div className="bg-layer-2 py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        ...
                        <form className="mt-6 flex flex-col space-y-4">
                            ...
                            <button
                                type="button"
                                className="inline-flex cursor-pointer items-center justify-center rounded-xl border-2 border-border bg-transparent px-4 py-2.5 text-sm font-semibold  text-text shadow-sm hover:text-white focus:text-white focus:outline-none focus:ring-2 focus:ring-white/80 focus:ring-offset-0 disabled:opacity-30 disabled:hover:text-text"
                            >
                                <svg
                                    viewBox="0 0 48 48"
